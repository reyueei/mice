...
class gsp_mice_homesetting_gsp extends GroovyPage {
...
printHtmlPart(18)
createTagBody(2, {->
invokeTag('img','g',49,['dir':("images"),'file':("add.png"),'height':("50px"),'width':("50px")],-1)
printHtmlPart(19)
})
invokeTag('link','g',49,['controller':("user"),'action':("create"),'target':("_blank")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1395092863922L
