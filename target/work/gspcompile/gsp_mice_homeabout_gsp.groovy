...
class gsp_mice_homeabout_gsp extends GroovyPage {
...
printHtmlPart(17)
invokeTag('img','g',45,['dir':("images"),'file':("aboutus.png"),'height':("15px"),'width':("15 px")],-1)
printHtmlPart(18)
invokeTag('img','g',52,['dir':("images"),'file':("MICE.jpg")],-1)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1395106592165L
